...
const useMedia = (media: string) => {
  const [match, setMatch] = React.useState<boolean | null>(null); // Cria um estado chamado match, e a função setMatch para alterar o estado. O valor inicial do estado é null ou pode ser boolean.
